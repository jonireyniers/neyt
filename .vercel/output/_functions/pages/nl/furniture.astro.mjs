...
›
</button> <div id="lightboxDots" class="absolute bottom-8 left-0 right-0 flex justify-center gap-2"></div> </div> ${renderComponent($$result2, "Footer", $$Footer, { "locale": locale })} ${renderScript($$result2, "/Users/jonireyniers/prod-neyt/neyt/src/pages/nl/furniture.astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "/Users/jonireyniers/prod-neyt/neyt/src/pages/nl/furniture.astro", void 0);

const $$file = "/Users/jonireyniers/prod-neyt/neyt/src/pages/nl/furniture.astro";
const $$url = "/nl/furniture";
