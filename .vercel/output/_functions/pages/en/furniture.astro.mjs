...
const $$Furniture = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Collection \u2014 Neyt Furniture", "description": "Discover the full collection of Neyt NV: bedrooms, dining rooms and office furniture of high quality.", "locale": locale }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "locale": locale })} ${maybeRenderHead()}<main class="section"> <div class="container"> <h1 class="text-3xl font-serif font-bold mb-8">Collectie</h1> <!-- Filter --> <div class="mb-8 flex flex-wrap gap-2"> <button class="filter-btn active px-4 py-2 bg-accent text-white rounded-md text-sm font-medium" data-category="all">
Alles
...
›
</button> <div id="lightboxDots" class="absolute bottom-8 left-0 right-0 flex justify-center gap-2"></div> </div> ${renderComponent($$result2, "Footer", $$Footer, { "locale": locale })} ${renderScript($$result2, "/Users/jonireyniers/prod-neyt/neyt/src/pages/en/furniture.astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "/Users/jonireyniers/prod-neyt/neyt/src/pages/en/furniture.astro", void 0);

const $$file = "/Users/jonireyniers/prod-neyt/neyt/src/pages/en/furniture.astro";
const $$url = "/en/furniture";
