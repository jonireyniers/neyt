...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Neyt Meubelen - Kwaliteitsmeubelen", "description": "Neyt NV levert kwaliteitsmeubelen voor slaapkamers, eetkamers en kantoren. B2B meubelproducent uit Beervelde, Belgi\xEB.", "locale": locale }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "locale": locale })} ${maybeRenderHead()}<main> <section class="relative h-[350px] md:h-[450px] bg-gradient-to-br from-primary to-secondary overflow-hidden"> <div class="absolute inset-0 bg-black/20"></div> <div class="relative container h-full flex flex-col justify-center items-center text-center text-white"> <img src="/images/furniture/prodlogo.png" alt="Neyt Meubelen" class="h-40 md:h-56 lg:h-64 w-auto mb-4 animate-fade-in"> <p class="text-base md:text-lg lg:text-xl mb-5 max-w-3xl font-light"> ${companyData.company.taglines[locale]} </p> <div class="flex gap-4"> <a href="/nl/furniture" class="inline-block bg-white text-primary px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg">
Bekijk collectie
</a> <a href="/nl/about" class="inline-block bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-primary transition-all">
Over Ons
  ...
  })} </div> <div class="text-center mt-12"> <a href="/nl/furniture" class="inline-block bg-accent text-white px-8 py-3 rounded-lg font-semibold hover:bg-accent/90 transition-colors">
...
Sluitingsdagen ${companyData.closingDates[0].year} </h3> <ul class="space-y-3"> ${companyData.closingDates[0].periods.map((period) => renderTemplate`<li class="flex items-start gap-3"> <span class="text-accent text-xl mt-0.5">•</span> <span class="text-gray-700">${period}</span> </li>`)} </ul> </div> </div> </section>`} <section class="section bg-gradient-to-br from-primary to-secondary text-white"> <div class="container text-center"> <h2 class="text-3xl md:text-4xl font-serif font-bold mb-4">
Geïnteresseerd in onze producten?
</h2> <a href="/nl/contact" class="inline-block bg-white text-primary px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg">
Neem contact op
</a> </div> </section> </main> ${renderComponent($$result2, "Footer", $$Footer, { "locale": locale })} ` })}`;
}, "/Users/jonireyniers/prod-neyt/neyt/src/pages/nl/index.astro", void 0);

const $$file = "/Users/jonireyniers/prod-neyt/neyt/src/pages/nl/index.astro";
const $$url = "/nl";
